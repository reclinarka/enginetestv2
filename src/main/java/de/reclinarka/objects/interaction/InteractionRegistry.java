...
public class InteractionRegistry extends Register<Interactable> implements Interactable{
    ...
    @Override
    public void setReciever( @Nullable InteractionRegistry interactionRegistry,String ID) {
